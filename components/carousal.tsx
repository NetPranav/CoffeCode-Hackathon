...
export default function Carousal() {
    ...
    const carousalStyle =
        "h-[60vh] w-screen relative overflow-hidden flex items-center justify-center";
    const frameStyle =
        "absolute h-full w-[50%] transition-[left] duration-1000 ease-out flex justify-center items-center";
    const bannerStyle =
        "h-[90%] w-[90%] origin-center bg-[cyan] transition-all duration-1000 ease-out text-6xl font-bold flex items-center justify-center rounded-xl";
